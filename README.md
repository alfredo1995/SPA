Anetes de iniciar o passo a passo da documentação, para os preguiçosos que so querem upar meu projeto kkkk
    
    git bash : git clone UrlDoRepositorioNoGitHubParaClonar
...
Executando comandos json para fazer o fake back end consumir a aplicação SPA
...
Volta para o visual studio Code e execute os comandos json novamente
